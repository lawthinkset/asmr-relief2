...
def upload_to_youtube(video_path, title, description, tags=None, category_id='22'):
    ...
    if tags is None:
        tags = ["asmr", "satisfying", "triggers", "tingles", "relaxation", "sleep", "shorts", "reels"]
...
def main():
    ...
    title = "Relaxing ASMR Daily"
    description = "#shorts #asmr #satisfying #triggers"
    tags = ["asmr", "satisfying", "triggers", "tingles"]
