...
def generate_caption():
    ...
    fallback_titles = [
        "Pure Tingles: Deep Sleep ASMR 😴",
        "Satisfying Sound Scapes for Your Brain ✨",
        "Instant Relaxation: The Ultimate Trigger Mix",
        "Close-up ASMR: Sensory Bliss 🎧",
        "Calm Your Mind with These Soft Sounds 🌊",
        "Deep Tingles Guaranteed (Wear Headphones!)",
        "The Most Satisfying ASMR Triggers",
        "Sleep Better Tonight: Gentle Relaxation",
        "Aesthetic ASMR: Visual & Audio Calm",
        "That Perfect Trigger... Tingles Incoming! ⚡",
        "Rainy Night ASMR for Deep Relaxation 🌧️",
        "Brain Massage: High-Quality Audio Bliss",
        "Whispers & Tingles: Your Nightly Reset",
        "Sensory Exploration: Satisfying Moments ✨",
        "Relaxing ASMR: Your Daily Escape",
    ]

    fallback_descriptions = [
        "Lose yourself in these satisfying sounds designed to trigger deep relaxation and tingles. Whether you're trying to sleep, study, or just unwind after a long day, these ASMR triggers are here to help you reset. Grab your headphones and let the sensory bliss take over. If this made you feel relaxed, don't forget to follow for more daily tingles! ✨ #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels",
        "The ultimate brain massage is here! 😂 These close-up sounds are specifically captured to provide the best possible ASMR experience. From soft whispers to crisp tapping, every detail is focused on your comfort. Drop a comment with your favorite trigger! 🎧✨ #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels",
        "Find your peace with this specially curated ASMR session. 🧠 We've gathered the most effective triggers to help you drift off into a deep sleep or find focus during the day. We hope these sounds bring you the calm you deserve! Share this with someone who needs some relaxation! 🌊💚 #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels",
        "Sensory bliss is just a play button away. 🎧 This collection of sounds is all about the little details that make ASMR so magical. Just look at the visual satisfaction paired with high-quality audio! Like if you felt the tingles! ⭐ #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels",
        "Escape the noise of the world and dive into this relaxing ASMR experience. 🎭 From gentle scratching to melodic tapping, it's the perfect way to end your day. Follow for your daily dose of calm! What's the one trigger that always gives you tingles? Comment below! 👇 #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels",
    ]
    ...
    vibes = [
        "crisp and detailed — focus on high-quality sound triggers",
        "soft and dreamy — capture the relaxing and sleepy side of ASMR",
        "rhythmic and satisfying — highlight the repetitive, calming patterns",
        "close-up and intimate — show off the sensory details of the triggers",
        "natural and organic — make it about rain, wood, or soft materials",
        "visual and auditory — focus on the perfect sync between sight and sound",
        "gentle and comforting — highlight the stress-relief and calming aspect",
    ]
    chosen_vibe = random.choice(vibes)

    prompt = (
        f"Write a completely unique, relaxing, and impressive title and description for a short ASMR video. "
        f"The content features high-quality triggers, tingles, and satisfying sounds. "
        f"Speak as a passionate ASMR creator — calm, inviting, and focused on sensory bliss. "
        f"IMPORTANT: Do NOT use generic openers like 'Welcome to ASMR' or 'Welcome to our channel'. Start directly with something engaging. "
        ...
        f"- Like if this gave you tingles! "
        f"- Comment your favorite trigger! "
        f"- Share this with someone who needs to relax! "
        f"- Follow for more daily ASMR bliss! "
        f"Include relevant hashtags in ALL LOWERCASE such as #asmr #satisfying #triggers #tingles #relaxation #sleep #shorts #reels. "
...
def main():
    ...
    # YouTube Shorts
    try:
        upload_to_youtube(video_path, title, description, tags=["asmr", "satisfying", "triggers", "tingles", "relaxation", "sleep", "shorts", "reels", "aesthetic", "calm", "sensory"])
